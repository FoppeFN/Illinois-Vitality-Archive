# Generated by Django 6.0 on 2026-04-04 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, db_index=True, default='Unknown', max_length=100)),
                ('middle_name', models.CharField(blank=True, db_index=True, default='', max_length=100)),
                ('sex', models.CharField(blank=True, choices=[('M', 'Male'), ('F', 'Female'), ('U', 'Unknown')], db_index=True, max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('marriage_date', models.DateField(blank=True, db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('death_date', models.DateField(blank=True, db_index=True, null=True)),
                ('death_age', models.IntegerField(blank=True, db_index=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(150)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commenter_name', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('commenter_email', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
            ...
            options={
                ...
                'ordering': ['seen_by_admin', '-creation_time'],
            },
        ),
        migrations.CreateModel(
            name='Birth',
